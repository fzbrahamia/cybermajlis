  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Message */}
        <p style={{ fontFamily: "var(--ui)", fontSize: "0.98rem", lineHeight: 1.65, color: "#6a4640", fontWeight: 300, marginBottom: "1.6rem", position: "relative", zIndex: 1 }}>
          {message}
        </p>
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: "0.6rem", position: "relative", zIndex: 1 }}>
          {onConfirm && (
            <button onClick={onConfirm} style={{ fontFamily: "var(--ui)", fontSize: "0.65rem", letterSpacing: "0.15em", textTransform: "uppercase", fontWeight: 700, padding: "0.6rem 1.3rem", borderRadius: 10, border: "none", background: "linear-gradient(135deg,#632024,#8B2635)", color: "#F3EAD7", cursor: "pointer", transition: "opacity 0.2s" }}
              onMouseEnter={e => (e.currentTarget.style.opacity = "0.85")}
              onMouseLeave={e => (e.currentTarget.style.opacity = "1")}>
              {resolvedConfirm}
            </button>
          )}
          <button onClick={onClose} style={{ fontFamily: "var(--ui)", fontSize: "0.65rem", letterSpacing: "0.15em", textTransform: "uppercase", fontWeight: 700, padding: "0.6rem 1.3rem", borderRadius: 10, border: "1px solid rgba(99,32,36,0.25)", background: "transparent", color: "#6a4640", cursor: "pointer", transition: "background 0.2s" }}
