  ...
  return (
    <>
      ...
      <div style={{ position:"fixed", bottom:24, right:24, zIndex:9000 }}>
        ...
        {/* Unread dot */}
        {!open && (
          <div style={{ position:"absolute", top:2, right:2, width:12, height:12, borderRadius:"50%", background:"#5b8db8", border:"2px solid white", animation:"blink 2s ease-in-out infinite" }} />
        )}
      </div>
        ...
        <div className="hamad-window" style={{ position:"fixed", bottom:92, right:24, zIndex:9001, width:360, maxHeight:"72vh", display:"flex", flexDirection:"column", borderRadius:20, overflow:"hidden", boxShadow:"0 20px 60px rgba(52,33,41,0.3), 0 0 0 1px rgba(74,45,54,0.1)", fontFamily:"'DM Sans',sans-serif" }}>
          ...
          <div style={{ background:"linear-gradient(135deg,#5D3A45,#4a2f3a)", padding:"12px 16px", display:"flex", alignItems:"center", gap:10, flexShrink:0, position:"relative", overflow:"hidden" }}>
            ...
            <button onClick={() => setVoiceSettingsOpen(v => !v)}
              ...
              style={{ background:"rgba(255,255,255,0.1)", border:"none", color:"rgba(243,234,215,0.85)", width:28, height:28, borderRadius:"50%", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center" }}>
              <Settings size={15} />
            </button>
            <button onClick={() => setOpen(false)}
              style={{ background:"rgba(255,255,255,0.1)", border:"none", color:"rgba(243,234,215,0.7)", width:28, height:28, borderRadius:"50%", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center" }}>
              <X size={16} />
            </button>
          </div>
...
//             </div>
//             <button onClick={() => setOpen(false)}
//               style={{ background:"rgba(255,255,255,0.1)", border:"none", color:"rgba(243,234,215,0.7)", fontSize:16, width:28, height:28, borderRadius:"50%", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center" }}>
//               ✕
//             </button>
//           </div>
