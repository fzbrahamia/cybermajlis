  ...
  "polymorphic-metamorphic": [
    ...
    },
    {
      ...
      options: [
        ...
        "كل من البرمجيات متعددة الأشكال والمتحولة",
        "لا شيء، التوقيعات تكتشف كل شيء",
      ],
      correctAnswer: "كل من البرمجيات متعددة الأشكال والمتحولة",
    },
    {
      question: "أي نوع من أنواع الكشف في برامج مكافحة الفيروسات سيكون الأكثر فاعلية ضد كل من البرمجيات متعددة الأشكال والمتحولة؟",
      options: [
