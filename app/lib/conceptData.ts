...
export const CATEGORIES: Category[] = [
  ...
  {
    id: "pull", domain: "water",
    name_en: "How salt and water hold on to each other", name_ar: "كيف يتمسك الملح والماء ببعضهما",
    line_en: "Water moves toward salt by itself. Going back is where it costs.",
    line_ar: "يتحرك الماء نحو الملح من تلقاء نفسه. والعودة هي ما يكلّف.",
    tone: "#3D6FB5",
  },
  {
    id: "leftovers", domain: "water",
    name_en: "Where the salt goes afterwards", name_ar: "إلى أين يذهب الملح بعد ذلك",
    line_en: "You did not destroy it. You concentrated it and put it somewhere.",
    line_ar: "أنت لم تُفنه. بل ركّزته ووضعته في مكان ما.",
    tone: "#A8323F",
  },
];
...
export const CONCEPTS: Concept[] = [
  ...
  // ── water ───────────────────────────────────────────────
  {
    ...
    category: "pull",
    state: "known",
    name_en: "The wall that only water can pass", name_ar: "الجدار الذي لا يعبره إلا الماء",
    line_en: "Water walks toward salt on its own. Nobody has to push it.",
    line_ar: "يمشي الماء نحو الملح وحده. ولا يحتاج أحد أن يدفعه.",
    minutes: 4,
    picture_en: "A wall with holes too small for salt, and water crossing it in one direction without being pushed.",
    picture_ar: "جدار بثقوب أضيق من أن يمر بها الملح، وماء يعبره في اتجاه واحد دون أن يدفعه أحد.",
    body_en: [
      "Put fresh water on one side of a wall and salty water on the other, and make the holes in the wall small enough that water fits through but salt does not.",
      "Nobody touches anything, and the water starts moving toward the salty side. It keeps going until the two sides pull on each other equally. That is osmosis, and it happens in your own body every second.",
      "The part that matters here is the direction. Going toward the salt is free. Sending the water back the other way is the thing you have to pay for, and everything about getting drinking water out of the sea is that payment.",
    ],
    body_ar: [
      "ضع ماء عذباً على جانب من جدار وماء مالحاً على الجانب الآخر، واجعل ثقوب الجدار أضيق من أن يمر بها الملح بينما يمر الماء.",
      "لا يلمس أحد شيئاً، ويبدأ الماء بالتحرك نحو الجانب المالح. ويستمر حتى يتساوى شدّ الجانبين. هذه هي التناضح، وتحدث في جسدك أنت كل ثانية.",
      "والمهم هنا هو الاتجاه. فالذهاب نحو الملح مجاني. أما إعادة الماء في الاتجاه الآخر فهو ما تدفع ثمنه، وكل ما يخص استخراج ماء الشرب من البحر هو هذا الثمن.",
    ],
    caveat_en: "The film draws one flat wall and two clean sides. A real membrane is a rolled sheet many metres long, and it clogs, which is a problem the picture cannot show you.",
    caveat_ar: "يرسم الفيلم جداراً مستوياً واحداً وجانبين نظيفين. أما الغشاء الحقيقي فصفيحة ملفوفة بطول أمتار، وهو ينسدّ، وهذه مشكلة لا تستطيع الصورة أن تريك إياها.",
    checks: [
  ...
  },
  {
    ...
    category: "pull",
    state: "open",
    name_en: "How hard the salt pulls", name_ar: "كم يشدّ الملح",
    line_en: "The pull is not a feeling. It is a number, and you can measure it.",
    line_ar: "الشدّ ليس إحساساً. بل رقم، ويمكن قياسه.",
    minutes: 4,
    picture_en: "A pressure dial, and the moment the needle passes the point where water starts crossing the wrong way.",
    picture_ar: "مؤشر ضغط، واللحظة التي تتجاوز فيها الإبرة النقطة التي يبدأ عندها الماء بالعبور عكس اتجاهه.",
    body_en: [
      "How hard salty water pulls has a size you can put on a dial. For ordinary seawater it is around twenty seven bar, which is about thirteen times the pressure in a car tyre.",
      "Push with less than that and nothing crosses. Push with more and water starts coming through the wall the wrong way, leaving the salt behind. This is why the pumps in a plant run near sixty bar rather than gently.",
      "The saltier the water, the higher that number goes, and the harder the pumps have to work to beat it. That is the sentence to remember, because the rest of the case grows out of it.",
    ],
    body_ar: [
      "لشدّ الماء المالح مقدار يمكن وضعه على مؤشر. وفي ماء البحر العادي يبلغ نحو سبعة وعشرين باراً، أي نحو ثلاثة عشر ضعف الضغط في إطار سيارة.",
      "ادفع بأقل من ذلك فلا يعبر شيء. وادفع بأكثر منه فيبدأ الماء بالعبور عبر الجدار عكس اتجاهه، تاركاً الملح خلفه. ولهذا تعمل مضخات المحطة قرب ستين باراً لا برفق.",
      "وكلما زادت ملوحة الماء ارتفع ذلك الرقم، واضطرت المضخات للعمل أشدّ لتتغلب عليه. هذه هي الجملة التي تُحفظ، لأن بقية القضية تنبت منها.",
    ],
    caveat_en: "Twenty seven bar is the least you could ever get away with, and only in theory. A working plant spends more than that, because water has to keep flowing rather than just barely start.",
    caveat_ar: "السبعة والعشرون باراً هي أقل ما يمكن الإفلات به، ونظرياً فقط. أما المحطة العاملة فتنفق أكثر، لأن الماء يجب أن يستمر في التدفق لا أن يكاد يبدأ.",
    checks: [
  ...
  },
  {
    ...
    category: "leftovers",
    state: "open",
    name_en: "What is left gets stronger", name_ar: "ما يتبقّى يصير أقوى",
    line_en: "Take half the water out and the salt that stays is twice as crowded.",
    line_ar: "خذ نصف الماء ويصير الملح الباقي أشدّ ازدحاماً بمرتين.",
    minutes: 4,
    picture_en: "The same amount of salt, in half as much water, then a third as much.",
    picture_ar: "الكمية نفسها من الملح، في نصف كمية الماء، ثم في ثلثها.",
    body_en: [
      "A plant does not remove salt from the sea. It removes water, and the salt it did not take stays behind in whatever water is left.",
      "So if you pull out half the water, the leftover is twice as salty as what you started with. Pull out seventy parts in a hundred and the leftover is more than three times as salty. This is arithmetic and there is no arguing with it.",
      "This is the trap that catches almost everybody. Recovering more water sounds like it should make less mess, and it does make a smaller amount of mess, but that smaller amount is stronger, and the total salt going back is exactly the same as it always was.",
    ],
    body_ar: [
      "لا تُخرج المحطة الملح من البحر. بل تُخرج الماء، ويبقى الملح الذي لم تأخذه في ما تبقّى من ماء.",
      "فإذا سحبت نصف الماء، صار المتبقّي أملح مرتين مما بدأت به. واسحب سبعين من مئة فيصير المتبقّي أملح بأكثر من ثلاث مرات. هذا حساب لا يُجادل فيه.",
      "وهذا هو الفخ الذي يقع فيه الجميع تقريباً. فاستخلاص ماء أكثر يبدو وكأنه يقلّل الفوضى، وهو فعلاً يقلّل كميتها، لكن تلك الكمية الأصغر أقوى، ومجموع الملح العائد هو هو لم يتغير.",
    ],
    caveat_en: "This treats the leftover as one even mixture. In a real plant it leaves in stages at different strengths, and it is usually blended with cooling water before it goes anywhere.",
    caveat_ar: "يعامل هذا المتبقّي كخليط واحد متجانس. أما في المحطة الحقيقية فيخرج على مراحل بتراكيز مختلفة، ويُمزج عادة بماء التبريد قبل أن يذهب إلى أي مكان.",
    checks: [
  ...
  },
  {
    ...
    category: "leftovers",
    state: "locked",
    name_en: "A sea that keeps what you give it", name_ar: "بحر يحتفظ بما تعطيه",
    line_en: "The Gulf is shallow, narrow at the mouth, and slow to change its water.",
    line_ar: "الخليج ضحل، ضيّق عند مدخله، وبطيء في تغيير مائه.",
    minutes: 4,
    picture_en: "A wide shallow dish with one narrow gap in the rim, and water taking years to work its way out.",
    picture_ar: "صحن واسع ضحل بفتحة ضيقة واحدة في حافته، وماء يستغرق سنوات ليشقّ طريقه للخارج.",
    body_en: [
      "The Gulf averages about thirty four metres deep, which is shallow for a sea, and it opens to the ocean through one narrow strait. Water that goes into it does not leave quickly.",
      "It is also already saltier than the open ocean: around forty parts per thousand against about thirty five, because the sun takes fresh water off the top faster than rain and rivers put it back.",
      "So it is a shallow, warm, already salty dish that every country around it drinks from, and that every country around it returns its leftovers to. Along the Arabian coast, where most of the plants are, the water takes something like three years to be exchanged.",
    ],
    body_ar: [
      "يبلغ متوسط عمق الخليج نحو أربعة وثلاثين متراً، وهو ضحل بمقياس البحار، وينفتح على المحيط عبر مضيق ضيق واحد. والماء الداخل إليه لا يخرج بسرعة.",
      "وهو أصلاً أملح من المحيط المفتوح: نحو أربعين جزءاً في الألف مقابل خمسة وثلاثين تقريباً، لأن الشمس تأخذ الماء العذب من سطحه أسرع مما يعيده المطر والأنهار.",
      "فهو إذن صحن ضحل دافئ مالح أصلاً، تشرب منه كل دولة حوله، وتعيد إليه كل دولة حوله ما يتبقّى لديها. وعلى الساحل العربي، حيث أغلب المحطات، يستغرق تبديل الماء نحو ثلاث سنوات.",
    ],
    caveat_en: "How long the water really takes to be exchanged is argued about, from a bit over a year to five. Three years is the figure for this coast, and the disagreement itself is worth knowing about.",
    caveat_ar: "مدة تبديل الماء فعلاً محل خلاف، من سنة ونيّف إلى خمس. وثلاث سنوات هو الرقم الخاص بهذا الساحل، والخلاف نفسه يستحق أن يُعرف.",
    checks: [
