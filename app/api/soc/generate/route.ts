...
function buildPrompt(threat: string, attempts: number, locale: string): string {
  ...
  if (isAr) {
    return (
      ...
      "الموظف المتضرر اسمه حمد (وليس حامد).\n" +
      "استخدم سياقاً قطرياً: بنوك، جهات حكومية، شركات اتصالات، شركات طاقة.\n\n" +
      "تعليمات مهمة لـ stepChat: اكتب فقط محتوى الرسالة بدون اسم المحلل في البداية. لا تكتب 'صقر:' أو 'أوركس:' أو غيرها. الأسماء تظهر تلقائياً في الواجهة.\n\n" +
      ...
      "  ],\n" +
      "  \"stepChat\": [\n" +
      "    [\"محتوى رسالة المحلل للخطوة 1 فقط\", \"محتوى رسالة المحلل الثاني للخطوة 1 فقط\"],\n" +
      "    [\"محتوى رسالة للخطوة 2\", \"محتوى رسالة ثانية للخطوة 2\"],\n" +
      "    [\"محتوى رسالة للخطوة 3\", \"محتوى رسالة ثانية للخطوة 3\"],\n" +
      "    [\"محتوى رسالة للخطوة 4\", \"محتوى رسالة ثانية للخطوة 4\"],\n" +
      "    [\"محتوى رسالة الحل للخطوة 5\", \"الدرس المستفاد\"]\n" +
      "  ],\n" +
      "  \"quiz\": {\n" +
