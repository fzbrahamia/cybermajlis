...
export const lessonsAr: Record<string, Lesson> = {
  ...
  router: {
    ...
    readingIntro: "الراوتر هو البوابة الرقمية للمنزل الذكي. الجزء الأول يتغير حسب الجهاز الذي تستخدمه، ثم تصبح خطوات الحماية متشابهة للجميع.",
    platformGuides: [
      {
        label: "Windows",
      ...
      },
      {
        ...
        whyPerStep: [
          ...
          "اختيار الشبكة المتصل بها يعطيك معلوماتها الكاملة.",
          "قسم التفاصيل يكشف المعلومات التقنية بأمان.",
